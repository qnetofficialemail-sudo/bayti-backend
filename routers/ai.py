...
def generate_instagram_content_v2(data: dict):
    ...
    if content_type == "sellers":
        topics = [
            ...
            "استوديو بيتي الذكي — حوّلي صورة منتجك إلى صورة احترافية مجاناً",
            "كيف يساعدك استوديو بيتي على بيع منتجاتك بشكل أسرع؟",
            "صورة منتج احترافية بدون كاميرا ولا مصور — مع بيتي",
...
- استوديو بيتي الذكي: يحلل صورة المنتج ويولّد prompt احترافي لتوليد صورة تسويقية مجاناً
- مستشار التسعير الذكي يساعد على تحديد السعر المناسب
- لوحة تحكم سهلة لإدارة المنتجات والطلبات
- الوصول لزبائن في جميع الإمارات
